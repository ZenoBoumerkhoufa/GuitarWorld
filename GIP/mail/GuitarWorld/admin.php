...
<!-- FORM -->
 ...
 <p>Updaten van klanten in de tabel tblKlanten</p>
 <p>Te wijzigen Klantnr
 <input type="text" name="tezoeken" id="tezoeken" placeholder="Klantnr">
 </p>
 <p>De te wijzigen waarden voor de gekozen klant</p>
 <p>
